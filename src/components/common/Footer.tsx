    ...
    <>
      <footer className="bg-gray-100 relative bottom-0 w-screen left-1/2 -translate-x-1/2 pt-4 mt-40">
          ...
          <div className="text-center items-center w-full ">
            <div className="xl:flex xl:justify-between w-full">
              <div className="xl:flex">
                <div
                  className="pb-8 pt-5 text-gray-400 font-semibold text-xl 
        xl:pr-10 xl:items-start xl:pt-8 "
                >
                  Ice climber
                </div>

                <div className="flex items-center justify-center xl:items-start">
                  <div
        ...
        xl:flex xl:gap-10 xl:pl-10 xl:pt-8"
              ...
              <div
                className="text-gray-400 font-normal text-[10px] pt-8 pb-24 xl:pb-12
