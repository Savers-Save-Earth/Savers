...
import { ProfileType, fetchBadges, fetchMissionDone, fetchProfileData } from "@/api/profile/fetchProfileData";
import Loading from "@/app/loading";

type Profile = Database["public"]["Tables"]["user"]["Row"];
const MyProfile = ({ params: { id } }: { params: { id: string } }) => {
  const searchId = id
  const { data: profileData, isLoading: profileDataLoading } = useQuery<ProfileType>(
